...
# 결과 창이 너무 크면 0.5배로 줄여서 보기
result_resized = cv.resize(result, None, fx=0.5, fy=0.5)
cv.imshow('Edge Detection + Morphology', result_resized)
